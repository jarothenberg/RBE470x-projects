...
class TestCharacter(CharacterEntity):
    ...
    def features(self, s: World, a: int): # TODO
        ...
        feature4 = self.normalizeDistFeature(self.getNearestMonsterDistEuclidian(s))**(self.getNearestMonsterDistEuclidian(s)/5) #distance of the nearest monster to BomberMan    
