...
=======
    ...
    def features(self, s: World, a: int): # TODO
        ...
        feature4 = self.getNearestMonsterDistEuclidian(s) < safeDist#self.normalizeDistFeature(self.getNearestMonsterDistEuclidian(s)) #distance of the nearest monster to BomberMan    
        feature5 = 0 #bombDistance #A* distance from physical bomb that bomberMan placed
        feature6 = self.normalizeDistFeature(self.getNearestMonsterDistEuclidian(s))#0 #self.getAverageDistanceOfAllMonsters(s) #average distance of all mosnters Euclidian Distance
